...
Esta definición se apoya en la [auditoría de producto y código](../docs/reviews/2026-09-10-auditoria-producto.md), la [propuesta de demo discutida](../plan/propuesta-demo-puentes-2026-09-10.md) y el [discovery previo](../docs/research/discovery-terac-2026-09.md). El [documento anterior](../plan/finalProduct.md) se usó como formato narrativo, no como límite inmutable de alcance.

La ejecución se organiza en [implementation-plan.md](implementation-plan.md), con criterios transversales en [spec.md](spec.md) y un archivo por ticket en `DemoPuentes/issues/`.

Se aprovechan el [dashboard actual](../frontend/components/research-dashboard/research-dashboard.tsx), la [investigación persistida](../frontend/lib/server/evaluations/research.ts), el [importador Luma](../frontend/lib/server/catalog/luma-adapter.ts), la [comparación](../frontend/lib/server/evaluations/compare.ts) y las [decisiones](../frontend/lib/server/decisions/store.ts). El [ADR](../docs/adr/0001-arquitectura-agente-growth-atlas.md) y los [contratos actuales](../frontend/lib/contracts/evaluation.ts) explican la base que deberá evolucionar.
